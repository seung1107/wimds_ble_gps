...
/* Unconfigured pins */
#define UART_GPS_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define UART_GPS_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define UART_GPS_REMOVE_TX_SCL_MISO_PIN      (1u)
...
/* Unconfigured pins */
#define UART_GPS_RX_WAKE_SDA_MOSI_PIN (0u == UART_GPS_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define UART_GPS_RX_SDA_MOSI_PIN     (0u == UART_GPS_REMOVE_RX_SDA_MOSI_PIN)
#define UART_GPS_TX_SCL_MISO_PIN     (0u == UART_GPS_REMOVE_TX_SCL_MISO_PIN)
...
****************************************/
    ...
    #include "UART_GPS_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (UART_GPS_RX_SDA_MOSI) */

#if (UART_GPS_RX_SDA_MOSI_PIN)
    #include "UART_GPS_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (UART_GPS_RX_SDA_MOSI) */

#if (UART_GPS_TX_SCL_MISO_PIN)
    #include "UART_GPS_uart_tx_i2c_scl_spi_miso.h"
#endif /* (UART_GPS_TX_SCL_MISO) */
...
***************************************/
...
#if (UART_GPS_RX_WAKE_SDA_MOSI_PIN)
    #define UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG \
                            (*(reg32 *) UART_GPS_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_PTR \
                            ( (reg32 *) UART_GPS_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_MASK \
                            (UART_GPS_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_POS \
                            (UART_GPS_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)

    #define UART_GPS_RX_WAKE_SDA_MOSI_INTCFG_REG \
                            (*(reg32 *) UART_GPS_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_GPS_RX_WAKE_SDA_MOSI_INTCFG_PTR \
                            ( (reg32 *) UART_GPS_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_GPS_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (UART_GPS_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define UART_GPS_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK \
                            ((uint32) UART_GPS_INTCFG_TYPE_MASK << \
                                      UART_GPS_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#endif /* (UART_GPS_RX_WAKE_SDA_MOSI_PIN) */

#if (UART_GPS_RX_SDA_MOSI_PIN)
    #define UART_GPS_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) UART_GPS_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_GPS_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) UART_GPS_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_GPS_RX_SDA_MOSI_HSIOM_MASK  (UART_GPS_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define UART_GPS_RX_SDA_MOSI_HSIOM_POS   (UART_GPS_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
#endif /* (UART_GPS_RX_SDA_MOSI_PIN) */

#if (UART_GPS_TX_SCL_MISO_PIN)
    #define UART_GPS_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) UART_GPS_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define UART_GPS_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) UART_GPS_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define UART_GPS_TX_SCL_MISO_HSIOM_MASK  (UART_GPS_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define UART_GPS_TX_SCL_MISO_HSIOM_POS   (UART_GPS_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
    ...
    #define UART_GPS_TX_HSIOM_PTR   ( (reg32 *) UART_GPS_tx_0__HSIOM)
...
#define UART_GPS_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define UART_GPS_RX_SDA_MOSI_PIN_INDEX       (0u)
#define UART_GPS_TX_SCL_MISO_PIN_INDEX       (1u)
...
#define UART_GPS_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << UART_GPS_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define UART_GPS_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << UART_GPS_RX_SDA_MOSI_PIN_INDEX)
#define UART_GPS_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << UART_GPS_TX_SCL_MISO_PIN_INDEX)
...
#define UART_GPS_DM_SIZE    (3)
#define UART_GPS_GET_P4_PIN_DM(reg, pos) \
    ( ((reg) & (uint32) ((uint32) UART_GPS_DM_MASK << (UART_GPS_DM_SIZE * (pos)))) >> \
                                                              (UART_GPS_DM_SIZE * (pos)) )

#if (UART_GPS_TX_SCL_MISO_PIN)
    #define UART_GPS_CHECK_TX_SCL_MISO_PIN_USED \
                (UART_GPS_PIN_DM_ALG_HIZ != \
                    UART_GPS_GET_P4_PIN_DM(UART_GPS_uart_tx_i2c_scl_spi_miso_PC, \
                                                   UART_GPS_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (UART_GPS_TX_SCL_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
#elif (UART_GPS_RX_WAKE_SDA_MOSI_PIN)
    #define UART_GPS_SET_I2C_SCL_DR(val) \
                            UART_GPS_uart_rx_wake_i2c_sda_spi_mosi_Write(val)
    ...
    #define UART_GPS_WAIT_SCL_SET_HIGH  (0u == UART_GPS_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (UART_GPS_RX_SDA_MOSI_PIN)
    #define UART_GPS_SET_I2C_SCL_DR(val) \
                            UART_GPS_uart_rx_i2c_sda_spi_mosi_Write(val)
    ...
    #define UART_GPS_WAIT_SCL_SET_HIGH  (0u == UART_GPS_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (UART_GPS_TX_SCL_MISO_PIN)
    #define UART_GPS_WAIT_SDA_SET_HIGH  (0u == UART_GPS_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Unconfigured pins */
#define UART_GPS_REMOVE_MOSI_SCL_RX_WAKE_PIN    UART_GPS_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define UART_GPS_REMOVE_MOSI_SCL_RX_PIN         UART_GPS_REMOVE_RX_SDA_MOSI_PIN
#define UART_GPS_REMOVE_MISO_SDA_TX_PIN         UART_GPS_REMOVE_TX_SCL_MISO_PIN
...
/* Unconfigured pins */
#define UART_GPS_MOSI_SCL_RX_WAKE_PIN   UART_GPS_RX_WAKE_SDA_MOSI_PIN
#define UART_GPS_MOSI_SCL_RX_PIN        UART_GPS_RX_SDA_MOSI_PIN
#define UART_GPS_MISO_SDA_TX_PIN        UART_GPS_TX_SCL_MISO_PIN
...
#define UART_GPS_SS0_PIN                UART_GPS_RTS_SS0_PIN
    ...
    #define UART_GPS_MOSI_SCL_RX_WAKE_HSIOM_REG     UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_GPS_MOSI_SCL_RX_WAKE_HSIOM_PTR     UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_GPS_MOSI_SCL_RX_WAKE_HSIOM_MASK    UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_GPS_MOSI_SCL_RX_WAKE_HSIOM_POS     UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define UART_GPS_MOSI_SCL_RX_WAKE_INTCFG_REG    UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_GPS_MOSI_SCL_RX_WAKE_INTCFG_PTR    UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define UART_GPS_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_GPS_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  UART_GPS_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (UART_GPS_RX_WAKE_SDA_MOSI_PIN) */

#if (UART_GPS_MOSI_SCL_RX_PIN)
    #define UART_GPS_MOSI_SCL_RX_HSIOM_REG      UART_GPS_RX_SDA_MOSI_HSIOM_REG
    #define UART_GPS_MOSI_SCL_RX_HSIOM_PTR      UART_GPS_RX_SDA_MOSI_HSIOM_PTR
    #define UART_GPS_MOSI_SCL_RX_HSIOM_MASK     UART_GPS_RX_SDA_MOSI_HSIOM_MASK
    #define UART_GPS_MOSI_SCL_RX_HSIOM_POS      UART_GPS_RX_SDA_MOSI_HSIOM_POS
#endif /* (UART_GPS_MOSI_SCL_RX_PIN) */

#if (UART_GPS_MISO_SDA_TX_PIN)
    #define UART_GPS_MISO_SDA_TX_HSIOM_REG      UART_GPS_TX_SCL_MISO_HSIOM_REG
    #define UART_GPS_MISO_SDA_TX_HSIOM_PTR      UART_GPS_TX_SCL_MISO_HSIOM_REG
    #define UART_GPS_MISO_SDA_TX_HSIOM_MASK     UART_GPS_TX_SCL_MISO_HSIOM_REG
    #define UART_GPS_MISO_SDA_TX_HSIOM_POS      UART_GPS_TX_SCL_MISO_HSIOM_REG
...
#define UART_GPS_MOSI_SCL_RX_WAKE_PIN_INDEX UART_GPS_RX_WAKE_SDA_MOSI_PIN_INDEX
#define UART_GPS_MOSI_SCL_RX_PIN_INDEX      UART_GPS_RX_SDA_MOSI_PIN_INDEX
#define UART_GPS_MISO_SDA_TX_PIN_INDEX      UART_GPS_TX_SCL_MISO_PIN_INDEX
...
#define UART_GPS_MOSI_SCL_RX_WAKE_PIN_MASK UART_GPS_RX_WAKE_SDA_MOSI_PIN_MASK
#define UART_GPS_MOSI_SCL_RX_PIN_MASK      UART_GPS_RX_SDA_MOSI_PIN_MASK
#define UART_GPS_MISO_SDA_TX_PIN_MASK      UART_GPS_TX_SCL_MISO_PIN_MASK
