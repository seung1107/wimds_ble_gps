...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    /* Eddystone service */
    {
        0x000Cu, /* Handle of the Eddystone service */ 
        {
            {
    ...
    {
        0x000Du, /* Handle of the Eddystone Configuration service */ 
        {

            /* Lock State characteristic */
            {
                0x000Fu, /* Handle of the Lock State characteristic */ 
            ...
            /* Lock characteristic */
            {
                0x0012u, /* Handle of the Lock characteristic */ 
            ...
            {
                0x0015u, /* Handle of the Unlock characteristic */ 
            ...
            {
                0x0018u, /* Handle of the URI Data characteristic */ 
            ...
            {
                0x001Bu, /* Handle of the URI Flags characteristic */ 
            ...
            {
                0x001Eu, /* Handle of the Advertised Tx Power Levels characteristic */ 
            ...
            {
                0x0021u, /* Handle of the Tx Power Mode characteristic */ 
            ...
            {
                0x0024u, /* Handle of the Beacon Period characteristic */ 
            ...
            {
                0x0027u, /* Handle of the Reset characteristic */ 
